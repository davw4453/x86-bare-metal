...
gdt_start:                     ; Label the GDT start so it can be pointed to in the GDT descriptor
...
gdt_end:                       ; label the GDT end for our GDT descriptor.
...
gdt_descriptor:
  ...
  ; GDT address: gdt_start
    ...
    dw gdt_end - gdt_start - 1 ; Bytes 0-1: GDT size (always 1 less than true size).
    ...
    dd gdt_start               ; Bytes 2-5: GDT address.
